...
module.exports = {
	// controller for viewing the add product page
	...
	// controller logic for adding the products to the database
	addProducts: async (req, res, next) => {
		...
		try {
			...
			const { productname, productdiscount, model, featured, features, description, shortdescription, category, tags } = req.body;
	...
	// controller logic for editing the products
	...
	// controller for listing or unlisting the products
	...
	// controller for deleting the image from edit products
	deleteImage: async (req, res) => {
		try {
			const { _id, imagePath } = req.query;

			const product = await productModel.findOneAndUpdate({ _id: _id }, { $pull: { images: imagePath } }, { new: true });
	...
	// controller for viewing the added products
	...
	// controller for viewing the results produced from search
	...
	// controller for viewing the reviews on products
